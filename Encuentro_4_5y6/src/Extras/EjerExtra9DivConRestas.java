...
public class EjerExtra9DivConRestas {
    ...
    public static void main(String[] args) {
        ...
        while (n1>n2) {//hasta que primer numero sea menor al segundo
            residuo=n1-n2;//restando
            n1=residuo;//le da un nuevo valor al primer numero
            cont++;//Cantidad de veces que resta
        }
